...
namespace Isis {
   ...
   *
   */
  LutiDistortionMap::LutiDistortionMap(Camera *parent) : CameraDistortionMap(parent, 1) {
  }

  /**
   * @param naifIkCode 
   */
  void LutiDistortionMap::SetDistortion(const int naifIkCode) {
   ...
   */
  bool LutiDistortionMap::SetFocalPlane(const double dx, const double dy) {
    p_focalPlaneX = dx;
    p_focalPlaneY = dy;
   ...
   * @see SetDistortion
   */
  bool LutiDistortionMap::SetUndistortedFocalPlane(const double ux, const double uy) {
